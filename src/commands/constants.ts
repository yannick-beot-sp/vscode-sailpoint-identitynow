...
export const EXPORT_CLOUD_RULE_XML_VIEW = `${COMMAND_PREFIX}.cloud-rule.export-xml.view`;
export const EXPORT_CLOUD_RULE_XML_FILE = `${COMMAND_PREFIX}.cloud-rule.export-xml.file`;
