...
export const AGGREGATE_MACHINE_IDENTITIES = `${COMMAND_PREFIX}.aggregate-machine-identities`;
export const AGGREGATE_MACHINE_IDENTITIES_DISABLE_OPTIMIZATION = `${COMMAND_PREFIX}.aggregate-machine-identities-disable-optimization`;
export const MACHINE_IDENTITIES_FILTER_VIEW = `${COMMAND_PREFIX}.machine-identities.filter`;
export const MACHINE_IDENTITIES_UPDATE_FILTER_VIEW = `${COMMAND_PREFIX}.machine-identities.update-filter`;
export const EDIT_MACHINE_ACCOUNT_SUBTYPE_APPROVAL_CONFIG = `${COMMAND_PREFIX}.machine-account-subtype.edit.approval-config`;
...
export const IMPORT_CLOUD_RULE_CONFIG_VIEW = `${COMMAND_PREFIX}.cloud-rule.import-config.view`;
export const IMPORT_CLOUD_RULE_CONFIG_ICON_VIEW = `${COMMAND_PREFIX}.cloud-rule.import-config.icon-view`;
export const VIEW_CLOUD_RULE_SCRIPT = `${COMMAND_PREFIX}.cloud-rule.view-script`;
export const EXPORT_CLOUD_RULE_SCRIPT_VIEW = `${COMMAND_PREFIX}.cloud-rule.export-script.view`;
