...
export const EDIT_NOTIFICATION_TEMPLATE_BODY = `${COMMAND_PREFIX}.notification-template.edit-body`;
export const PREVIEW_NOTIFICATION_TEMPLATE_BODY = `${COMMAND_PREFIX}.notification-template.preview-body`;
